    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="card widget-flat">
                <div class="card-body">
                    <div class="float-right">
                        <i class="mdi mdi-currency-usd widget-icon" style="color: black; background-color:#df8180;"></i>
                    </div>
                    <h5 class="text-muted font-weight-normal mt-0" title="Total Profit">Total Profit</h5>
        ...
        <div class="col-lg-3">
            <div class="card widget-flat">
                <div class="card-body">
                    <div class="float-right">
                        <i class="mdi mdi-pulse widget-icon" style="color: black; background-color:#df8180;"></i>
                    </div>
                    <h5 class="text-muted font-weight-normal mt-0" title="Total">Total</h5>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <a href="" class="btn btn-danger btn-sm" style="position: absolute; right:2%;">+ Add
                            User</a>
                    </div>
                    <br>
