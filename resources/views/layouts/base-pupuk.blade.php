                    ...
                    <div class="side-nav-link">
                        <a href="javascript: void(0);">
                            ...
                            <div class="user-avatar">
                                <span class="leftbar-user-name text-white">Dominic Keller</span>
                                <p class="text-white font-14">Founder</p>
                            </div>
                        </a>
                    </div>
                    ...
                    <ul class="list-unstyled topbar-right-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user arrow-none mr-0" data-toggle="dropdown"
                                ...
                                <span>
                                    <span class="account-user-name text-white">Dominic Keller</span>
                                    <span class="account-position text-white">Founder</span>
                                </span>
                            </a>
                            <div
